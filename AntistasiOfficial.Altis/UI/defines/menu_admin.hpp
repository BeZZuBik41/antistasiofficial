...
#define ADMIN_GARBAGE "closeDialog 0; [[], ""garbageCleaner.sqf""] remoteExec [""execVM"", 2];"
...
#define ADMIN_TGLPN "if(server getVariable [""hardMode"",false]) then {server setvariable [""hardmode"",flase,true]; (_this select 0) ctrlSetTextColor [1,0,0,1];} else {server setvariable [""hardmode"",true,true];(_this select 0) ctrlSetTextColor [0.18,0.545,0.341,1];};"
...
#define ADMIN_TEXTS_R ["STR_UI_ADMIN_TGLFT_TEXT", "STR_UI_ADMIN_GARBAGE_TEXT", "STR_UI_ADMIN_GEARRES_TEXT", "STR_UI_ADMIN_TGLTM_TEXT","STR_UI_ADMIN_TGLPN_TEXT"]
...
#define ADMIN_TTS_R ["STR_UI_ADMIN_TGLFT_TT", "STR_UI_ADMIN_GARBAGE_TT", "STR_UI_ADMIN_GEARRES_TT", "STR_UI_ADMIN_TGLTM_TT","STR_UI_ADMIN_TGLPN_TT"]